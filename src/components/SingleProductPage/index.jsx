...
export default function SingleProductPage() {
  ...
  const reviewAction = async () => {
    setLoading(true);
    try {
      const response = await axios.post("https://django-backend-8bva.onrender.com/review/", {
        rating: rating,
        comment: message,
        product: id
      }, {
  ...
  const editYourReview = async(id) => {
      console.log("Clicked")
    
     await axios.patch(`https://django-backend-8bva.onrender.com/review/get/${id}/`, {
        comment: message,
        rating: rating,
      }, {
        headers: {
  ...
  const deleteYourReview = async (id) => {
    await axios.delete(`https://django-backend-8bva.onrender.com/review/get/${id}/`, {
        headers: {
          "Authorization": `Bearer ${localStorage.getItem("accessToken")}`
        }
      })
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(`https://django-backend-8bva.onrender.com/review/product/${id}/`)
      try {
        ...
        <div className="single-product-wrapper w-full ">
          <div className="product-view-main-wrapper bg-white pt-[30px] w-full">
            ...
            <div className="w-full bg-white pb-[60px]">
              <div className="container-x mx-auto">
                <ProductView restart={restart} id={id} reportHandler={() => setReport(!report)} />
              </div>
            </div>
          </div>
