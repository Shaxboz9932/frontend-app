...
export default function CardPage({ cart = true }) {
  ...
  const handleDelete = (pk) => {
    deleteItem(accessToken, pk)
  }

  const handleUpdateQty = (pk, qty) => {
    updateQuantity(accessToken, pk, qty)
  }

  console.log("Cartitems", cartItems.lenght)


  return (
    <Layout childrenClasses={cart ? "pt-0 pb-0" : ""}>
      {cartItems.length === 0 ? (
        <div className="cart-page-wrapper w-full mt-20">
                ...
                <div className="sm:w-[370px] w-full border border-[#EDEDED] px-[30px] py-[26px]">
                  ...
                  <div className="total mb-6">
                    <div className=" flex justify-between">
                      ...
                      <p className="text-[18px] font-medium text-qred">${totalPrice}</p>
                    </div>
                  </div>
                  <Link to="/checkout">
