...
export default function ProductsTable({ className, cartItems, handleDelete, handleUpdateQty }) {
          ...
          <tbody>
            ...
            {cartItems && cartItems.map((item) => (
              <tr key={item.id} className="bg-white border-b hover:bg-gray-50">
                ...
                <td className=" py-4">
                  <div className="flex justify-center items-center">
                    <InputQuantityCom id={item.id} handleUpdateQty={handleUpdateQty} qty={item.quantity}/>
                  </div>
                </td>
                <td className="text-right py-4">
                  <div className="flex space-x-1 items-center justify-center">
                    <span className="text-[15px] font-normal">${item.quantity * item.product.price}</span>
                  </div>
                </td>
                <td className="text-right py-4">
                  <div className="flex space-x-1 items-center justify-center">
